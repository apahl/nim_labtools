...
type
  Fields =  enum
    fNone, fMolwt, fWeight, fVol, fConc

var
  mainwin: ptr Window
  label1: ptr Label
  entryWeight, entryVol, entryMolwt, entryConc: ptr Entry
  cbWeightUnit, cbVolUnit, cbConcUnit: ptr Combobox
  useComma = false
...
proc onBtnClearClicked(b: ptr Button; data: pointer) {.cdecl.} =
  ...
  entrySetText(entryMolWt, "")
  entrySetText(entryWeight, "")
  entrySetText(entryVol, "")
